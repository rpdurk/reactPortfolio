...
export const ContactPage = () => {
  return (
    ...
    <section className="text-center">
        <div class="col-md">
            <h1 class="projects" style={{fontSize: 36}}>Contact Me</h1>
            <p style={{fontSize: 26}}>If something here interests you or you would like to get in touch, contact me.</p>
        </div>
    </section>
    <br />
